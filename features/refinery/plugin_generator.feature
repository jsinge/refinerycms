Feature: Plugin generation
  ...
  Scenario: Generating a plugin with a name
    ...
    And I should have a file "vendor/plugins/products/app/views/admin/products/_form.html.haml"
    And I should have a file "vendor/plugins/products/app/views/admin/products/_sortable_list.html.haml"
    And I should have a file "vendor/plugins/products/app/views/admin/products/edit.html.haml"
    And I should have a file "vendor/plugins/products/app/views/admin/products/index.html.haml"
    And I should have a file "vendor/plugins/products/app/views/admin/products/new.html.haml"
    And I should have a file "vendor/plugins/products/app/views/admin/products/_product.html.haml"
    And I should have a file "vendor/plugins/products/app/views/products/index.html.haml"
    And I should have a file "vendor/plugins/products/app/views/products/show.html.haml"
